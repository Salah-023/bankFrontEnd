<template>
    <div class="h-screen flex justify-center items-center">
        <div class="max-w-md">
            ...
            <div v-if="hasErrors" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                role="alert">
            ...
            <div v-if="hasSuccess" class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative"
                role="alert">
